  ...
  return {
    ...
    strategies: {
      grid: {
        ...
        historyHours: envNumber('GRID_HISTORY_HOURS', 72, 1, 2160),
        reanchorMinutes: envNumber('GRID_REANCHOR_MIN', 5, 1, 1440),
        deadzoneSteps: envNumber('GRID_DEADZONE_STEPS', 0.5, 0, 10),
        reanchorConfirmPolls: envNumber('GRID_REANCHOR_CONFIRM_POLLS', 3, 1, 100),
        compoundPct: envNumber('GRID_COMPOUND_PCT', 1.0, 0, 10),
        volSizingEnabled: envBool('GRID_VOL_SIZING', true),
        vwapSkewEnabled: envBool('GRID_VWAP_SKEW', true),
        skewStrength: envNumber('GRID_SKEW_STRENGTH', 2.0, 0, 10),
      },
      dca: {
        baseAsset: 'SOL',
        quoteAsset: 'USDC',
        baseMint: 'So11111111111111111111111111111111111111112',
        quoteMint: 'EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v',
        intervalMinutes: envNumber('DCA_INTERVAL_MIN', 60, 1, 1440),
        usdcAmountPerBuy: envNumber('DCA_USDC_PER_BUY', 10, 1, 1e6),
        dipPctBelowVwap: envNumber('DCA_DIP_PCT', 3, 0.01, 100),
        enabled: envBool('DCA_ENABLED', true),
        takeProfitPct: envNumber('DCA_TP_PCT', 8, 0, 100),
        trailingPct: envNumber('DCA_TRAILING_PCT', 2, 0, 99),
        takeProfitSlicePct: envNumber('DCA_TP_SLICE_PCT', 25, 1, 100),
        ...
        vaHorizonBuys: envNumber('DCA_VA_HORIZON_BUYS', 30, 1, 100000),
